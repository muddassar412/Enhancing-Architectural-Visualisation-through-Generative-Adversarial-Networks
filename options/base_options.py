...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--pillar_H', type=int, default=40, help='pillar_H')
        parser.add_argument('--pillar_W', type=int, default=56, help='pillar_W')
        parser.add_argument('--glass_H', type=int, default=48, help='glass_H')
        parser.add_argument('--glass_W', type=int, default=48, help='glass_W')
        parser.add_argument('--balconie_H', type=int, default=40, help='balconie_H')
        parser.add_argument('--balconie_W', type=int, default=64, help='balconie_W')
        parser.add_argument('--roof_H', type=int, default=40, help='roof_H')
        parser.add_argument('--roof_W', type=int, default=56, help='roof_W')
        parser.add_argument('--railings_H', type=int, default=48, help='railings_H')
        parser.add_argument('--railings_W', type=int, default=48, help='railings_W')
        parser.add_argument('--windows_H', type=int, default=40, help='windows_H')
        parser.add_argument('--windows_W', type=int, default=64, help='windows_W')
