...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lm_dir', type=str, default='/home/ali1/datasets/Architectural_Visualisation/landmark/', help='path to facial landmarks')
        parser.add_argument('--bg_dir', type=str, default='/home/ali1/datasets/Architectural_Visualisation/mask/', help='path to background masks')
        parser.add_argument('--data_json', default='/home/ali1/datasets/Architectural_Visualisation/anno_train.json', help='path to att')
        # ============================================loss=========================================================
        # L1 and local
        ...
        parser.add_argument('--addw_pillar', type=float, default=1.0, help='additional weight for pillar region')
        parser.add_argument('--addw_glass', type=float, default=1.0, help='additional weight for glass region')
        parser.add_argument('--addw_balconie', type=float, default=1.0, help='additional weight for balconie region')
        parser.add_argument('--addw_railings', type=float, default=1.0, help='additional weight for railings region')
        parser.add_argument('--addw_window', type=float, default=1.0, help='additional weight for window region')
        parser.add_argument('--addw_roof', type=float, default=1.0, help='additional weight for roof region')
        parser.add_argument('--addw_sky', type=float, default=1.8, help='additional weight for sky region')
